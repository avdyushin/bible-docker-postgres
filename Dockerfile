...
COPY data/kjv_bible_books.sql /docker-entrypoint-initdb.d/50-kjv-bible-books.sql
COPY data/kjv_bible_verses.sql /docker-entrypoint-initdb.d/60-kjv-bible-verses.sql
